import { Body, Controller, Get, Patch, Param, Query, Post, Delete, NotFoundException, Session, UseGuards } from '@nestjs/common';
...
export class UsersController {
    ...
    // You can only access this if you are signed in
    @Get('/whoami')
    @UseGuards(AuthGaurd)
